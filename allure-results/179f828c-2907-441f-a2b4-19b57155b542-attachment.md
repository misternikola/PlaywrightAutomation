...
- Name: test
- Location: C:\Users\NB-0358\Documents\PlaywrightAutomation\tests\Retry.spec.js:9:5
...
Call log:
  - waiting for locator('//a[normalize-space()="Add to cart"]')
    ...
    at HomePage.addProducttocart (C:\Users\NB-0358\Documents\PlaywrightAutomation\Pages\HomePage.js:24:49)
    at C:\Users\NB-0358\Documents\PlaywrightAutomation\tests\Retry.spec.js:18:5
```
...
```ts
   ...
   6 |         this.addtocart='//a[normalize-space()="Add to cart"]';
   7 |         this.cart='#cartur'
   8 |     }
   9 |
  ...
  22 |             }
  23 |         })
> 24 |         await this.page.locator(this.addtocart).click();
     |                                                 ^ Error: locator.click: Test timeout of 30000ms exceeded.
  25 |     }
  26 |
  27 |     async gotocart() {
