...
- Location: C:\Users\NB-0358\Documents\PlaywrightAutomation\tests\Hooks.spec.js:19:6
...
Call log:
  - waiting for locator('//a[normalize-space()="Samsung galxy s6"]')
    - waiting for navigation to finish...
    - navigated to "https://www.demoblaze.com/index.html"

    at C:\Users\NB-0358\Documents\PlaywrightAutomation\tests\Hooks.spec.js:27:65
```
...
```ts
  ...
  17 | });
  18 |
  19 | test.only('Add product to cart', async ({page}) => {
...
> 27 | await page.locator('//a[normalize-space()="Samsung galxy s6"]').click();
     |                                                                 ^ Error: locator.click: Test timeout of 30000ms exceeded.
