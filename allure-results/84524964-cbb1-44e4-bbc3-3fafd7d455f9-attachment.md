...
- Name: Home page test
- Location: C:\Users\NB-0358\Documents\PlaywrightAutomation\tests\Hooks3.spec.js:20:5
...
Received length: 0
Received array:  []
    at C:\Users\NB-0358\Documents\PlaywrightAutomation\tests\Hooks3.spec.js:22:20
```
...
> 22 |   expect(products).toHaveLength(9); 
  ...
  24 | });
  25 |
  26 | test('Add product to cart', async () => {
  27 |
